            ...
            <div class="box">
                ...
                <el-form class="form-box" label-width="auto" label-position="top" size="large" :model="user" hide-required-asterisk>
                    <el-form-item prop="username">
                        ...
                        <el-input v-model="user.username" placeholder="账户" clearable :class="{'error-input':error.username}"></el-input>
                        <el-text class="mx-1" :class="error.username ? 'opacity-100' : 'opacity-0'" type="danger" size="small">用户名长度为3-10位</el-text>
                    </el-form-item>
                    <el-form-item prop="password">
                        <template #label>密码</template>
                        <el-input v-model="user.password" placeholder="密码" type="password" show-password clearable  :class="{'error-input':error.password}"></el-input>
                        <el-text class="mx-1" :class="error.password ? 'opacity-100' : 'opacity-0'" type="danger" size="small">密码长度为6-18位</el-text>
                    </el-form-item>
...
.warp {
    ...
    .box {
        @apply bg-white flex flex-col gap-4 rounded-md shadow-2xl bg-opacity-80 backdrop-blur-md;
        // 响应式调整
